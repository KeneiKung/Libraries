...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		['Default'] = { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"141414","AccentColor":"ffa2e7","BackgroundColor":"141414","OutlineColor":"323232"}') },
	...
	function ThemeManager:CreateThemeManager(groupbox)
    	...
    	groupbox:AddToggle('Rainbow GUI',{
            Text = 'Rainbow Gui',
            Default = self.Library.Rainbow or false
        }):OnChanged(function(value)
            getgenv().RainbowGui = value
        end)
